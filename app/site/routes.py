...
@site.route('/addtocart/<int:prodid>')
...
@site.route('/removefromcart/<int:cartid>') #removes an item from the cart
...
@site.route('/emptycart', methods=['POST'])
def emptyCart():
...
@site.route('/edititem/<int:prodid>')
def editItem(prodid):
